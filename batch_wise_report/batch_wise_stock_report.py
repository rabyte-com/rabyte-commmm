...
def send_email(body, attachment_path=None):
    ...
    to_email = ["praveen.kumar.wm@rabyte.com", "nadeem.khan.vv@rabyte.com", "krishna.kumar.zx@rabyte.com", "bhupendra.kumar.yo@rabyte.com"]
    cc_email = [ "arjun.batra.az@rabyte.com", "harimohan.pathak.ug@rabyte.com", "anurag.arora.zl@rabyte.com"]
