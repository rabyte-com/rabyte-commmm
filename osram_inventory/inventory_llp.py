...
def transform_to_edifact_structure(cursor):
    ...
    total_segments = 8 + 1 * 6  # UNA, UNB, UNH, UNT, UNZ, and 6 segments per row
    ...
    try:
        ...
        if connection:
            ...
            query = """
                    ...
                    T2."CardCode",T3."Name" "Make", T4."Name" "Make+DIV", T2."OnHand", 
                    T2."BuyUnitMsr",T2."LastPurDat", T2."LstEvlPric" FROM "RABYTE_LLP_LIVE01_0808".OADM  
                    T1, "RABYTE_LLP_LIVE01_0808".OITM T2 INNER JOIN "RABYTE_LLP_LIVE01_0808"."@MAKE_FULL_1"  
                    T3 ON T2."U_MF_1" = T3."Code" INNER JOIN "RABYTE_LLP_LIVE01_0808"."@MAKE_FULL_2"  
                    T4 ON T2."U_M_F_2" = T4."Code" where T3."Name"='ams Osram' 
                    LIMIT 5
                """
